...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#fcfdfe] font-sans flex flex-col overflow-x-hidden" dir="rtl">
      ...
      {/* Вернули pt-24, чтобы вытащить заголовок */}
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 md:px-8 pt-24 md:pt-28 flex flex-col items-center">
          ...
          <div className="w-full max-w-4xl flex flex-col items-center mt-8 md:mt-12 mb-4">
